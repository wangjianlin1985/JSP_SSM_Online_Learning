    ...
    <div class="row">
        <div class="col-lg-12">
            <ul class="nav nav-tabs wk-nav-menu" id="wk-nav-menu">
                <li role="presentation"><a href="#" id="wk-menu-panel-item-searchCourseInfo" class="wk-main-menu-item">课程信息查询</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-searchCollegeVideoInfo" class="wk-main-menu-item">在线课程视频</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-searchCollegeFileInfo" class="wk-main-menu-item">课程文件下载</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-searchDiscussInfo" class="wk-main-menu-item">话题讨论</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-searchNoticeInfo" class="wk-main-menu-item">查看公告</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-searchTaskInfo" class="wk-main-menu-item">完成作业</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-searchStudentTaskInfo" class="wk-main-menu-item">查询已完成作业</a></li>
