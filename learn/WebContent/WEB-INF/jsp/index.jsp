    ...
    <div class="row">
        <div class="col-lg-12">
            <ul class="nav nav-tabs wk-nav-menu" id="wk-nav-menu">
                <li role="presentation"><a href="#" id="wk-menu-panel-item-createStudent" class="wk-main-menu-item">新增学生</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-searchStudent" class="wk-main-menu-item">学生信息查询</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-createTeacher" class="wk-main-menu-item">新增教师</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-searchTeacher" class="wk-main-menu-item">教师信息查询</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-createCollege" class="wk-main-menu-item">新增学院</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-searchCollege" class="wk-main-menu-item">学院信息管理</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-createCourse" class="wk-main-menu-item">新增课程</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-searchCourse" class="wk-main-menu-item">课程信息查询</a></li>
