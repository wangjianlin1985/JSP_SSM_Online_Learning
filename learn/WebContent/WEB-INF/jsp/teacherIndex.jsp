    ...
    <div class="row">
        <div class="col-lg-12">
            <ul class="nav nav-tabs wk-nav-menu" id="wk-nav-menu">
                <li role="presentation"><a href="#" id="wk-menu-panel-item-searchWorker" class="wk-main-menu-item">上传课程视频</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-searchManager" class="wk-main-menu-item">上传课程文件</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-createWorksite" class="wk-main-menu-item">课程视频查询</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-searchWorksite" class="wk-main-menu-item">课程文件查询</a></li>
                <li role="presentation"><a href="#" id="wk-menu-panel-item-createPackage" class="wk-main-menu-item">作业信息查询</a></li>
